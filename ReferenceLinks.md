...
- [String](https://www.geeksforgeeks.org/dsa/string-data-structure/)

---

## Matrix

- [Matrix](https://www.geeksforgeeks.org/dsa/matrix/)

---

## Searching

- [All Searching Algorithms](https://www.geeksforgeeks.org/searching-algorithms/)
...
- [Sorting Algorithms Overview](https://www.geeksforgeeks.org/dsa/sorting-algorithms/)
...
- [Hashing Overview](https://www.geeksforgeeks.org/dsa/hashing-data-structure)
...
- [Linked List Overview](https://www.geeksforgeeks.org/dsa/linked-list-data-structure/)
...
- [Tree Overall](https://www.geeksforgeeks.org/dsa/tree-data-structure/)
...
- [Directed Cycle Detection](https://www.geeksforgeeks.org/detect-cycle-in-a-graph/)
- [Undirected Cycle Detection](https://www.geeksforgeeks.org/detect-cycle-undirected-graph/)

### Shortest Path

- [Dijkstra Shortest Path](https://www.geeksforgeeks.org/dsa/dijkstras-shortest-path-algorithm-greedy-algo-7/)
...
- [Kruskal's Algorithm](https://www.geeksforgeeks.org/dsa/kruskals-minimum-spanning-tree-algorithm-greedy-algo-2/)
- [Prim's Algorithm](https://www.geeksforgeeks.org/dsa/prims-minimum-spanning-tree-mst-greedy-algo-5/)
- [Prims's vs Kruskal's](https://www.geeksforgeeks.org/dsa/difference-between-prims-and-kruskals-algorithm-for-mst/)
